...
class Movie extends React.Component {
    getAverage() {
        if (this.props.ratings.metaCritic === 'null' || this.props.ratings.metaCritic === 0 || this.props.ratings.metaCritic === 'null\r') {return this.props.ratings.imdb}
        ...
        <div id='movie-container' key={this.props.id}>
            ...
            <div className="middle flex-stretch">
                ...
                <div className="footer ratings">
                    ...
                    <span className="flex-center logos"><img src={MetaCritic} height="40em" width="40em" alt="MetaCritic: "></img> {(!this.props.ratings.metaCritic || this.props.ratings.metaCritic === 'null\r' || this.props.ratings.metaCritic === 'null') ? 'N/A': this.props.ratings.metaCritic}</span>
                </div>
            </div>
